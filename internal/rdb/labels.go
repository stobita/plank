...
var LabelWhere = struct {
	...
	ID:        whereHelperuint{field: "`labels`.`id`"},
	Name:      whereHelperstring{field: "`labels`.`name`"},
	BoardID:   whereHelperuint{field: "`labels`.`board_id`"},
	CreatedAt: whereHelpernull_Time{field: "`labels`.`created_at`"},
	UpdatedAt: whereHelpernull_Time{field: "`labels`.`updated_at`"},
}
...
var (
	labelAllColumns            = []string{"id", "name", "board_id", "created_at", "updated_at"}
	labelColumnsWithoutDefault = []string{"name", "board_id"}
...
func (q labelQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Label, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "rdb: failed to execute a one query for labels")
	}
...
func (q labelQuery) All(ctx context.Context, exec boil.ContextExecutor) (LabelSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "rdb: failed to assign all query results to Label slice")
	}
...
func (q labelQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "rdb: failed to count labels rows")
	}
...
func (q labelQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "rdb: failed to check if labels exists")
	}
...
func (o *Label) CardsLabels(mods ...qm.QueryMod) cardsLabelQuery {
...
func (labelL) LoadCardsLabels(ctx context.Context, e boil.ContextExecutor, singular bool, maybeLabel interface{}, mods queries.Applicator) error {
	var slice []*Label
	var object *Label
	...
	query := NewQuery(qm.From(`cards_labels`), qm.WhereIn(`cards_labels.label_id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Label) AddCardsLabels(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*CardsLabel) error {
	var err error
...
func FindLabel(ctx context.Context, exec boil.ContextExecutor, iD uint, selectCols ...string) (*Label, error) {
	labelObj := &Label{}
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "rdb: unable to select from labels")
	}
...
func (o *Label) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("rdb: no labels provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "rdb: unable to insert into labels")
	}
	...
	if err != nil {
		return errors.Wrap(err, "rdb: unable to populate default values for labels")
	}
...
func (o *Label) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("rdb: unable to update labels, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "rdb: unable to update labels row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "rdb: failed to get rows affected by update for labels")
	}
...
func (q labelQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "rdb: unable to update all for labels")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "rdb: unable to retrieve rows affected for labels")
	}
...
func (o LabelSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "rdb: unable to update all in label slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "rdb: unable to retrieve rows affected all in update all label")
	}
	return rowsAff, nil
}
...
func (o *Label) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("rdb: no labels provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("rdb: unable to upsert labels, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "rdb: unable to upsert for labels")
	}
	...
	if err != nil {
		return errors.Wrap(err, "rdb: unable to retrieve unique values for labels")
	}
...
func (o *Label) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("rdb: no Label provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "rdb: unable to delete from labels")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "rdb: failed to get rows affected by delete for labels")
	}
...
func (q labelQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("rdb: no labelQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "rdb: unable to delete all from labels")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "rdb: failed to get rows affected by deleteall for labels")
	}
...
func (o LabelSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "rdb: unable to delete all from label slice")
	}
...
func (o *LabelSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "rdb: unable to reload all in LabelSlice")
	}
...
func LabelExists(ctx context.Context, exec boil.ContextExecutor, iD uint) (bool, error) {
	var exists bool
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "rdb: unable to check if labels exists")
	}
